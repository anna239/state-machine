...
public class StateMachineType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_qqmmse_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_qqmmse_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_qqmmse_a0(EditorContext editorContext, SNode node) {
