...
public class typeof_Transition_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode tr, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode stateMachine = SNodeOperations.as(SNodeOperations.getParent(SNodeOperations.getParent(tr)), "statemachine.structure.StateMachine");
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(tr, "do", true);
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:e8632312-5c38-45e4-b922-b0dc11caad25(statemachine.typesystem)", "4332044356532085352", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:e8632312-5c38-45e4-b922-b0dc11caad25(statemachine.typesystem)", "4332044356532085281", true), (SNode) new typeof_Transition_InferenceRule.QuotationClass_v2yaho_a0a1a0().createNode(SLinkOperations.getTarget(stateMachine, "type", true), typeCheckingContext), false, true, _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_v2yaho_a0a1a0 {
    public QuotationClass_v2yaho_a0a1a0() {
    }
